...
$string['error:useridmissing'] = 'Line {$a}: the user ID column is empty.';
$string['error:useridinvalid'] = 'Line {$a->line}: user with ID {$a->userid} was not found.';
$string['error:useridinvalidsummary'] = 'Rows skipped because of invalid user IDs: {$a}.';
