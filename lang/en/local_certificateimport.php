...
$string['result:summary'] = '{$a->ready} of {$a->total} rows converted and queued.';
...
$string['report:issues:description'] = 'Browse every certificate queued or issued through the importer, filter by template/status/date, export to CSV, or reissue any revoked records.';
