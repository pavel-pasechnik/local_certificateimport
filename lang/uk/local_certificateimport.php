...
$string['error:csvcolumns'] = 'Рядок {$a}: неправильний формат (очікується userid,templateid,code,filename,timecreated).';
...
$string['error:codeempty'] = 'Код сертифіката не може бути порожнім.';
