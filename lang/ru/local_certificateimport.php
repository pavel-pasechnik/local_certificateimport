...
$string['error:useridmissing'] = 'Строка {$a}: столбец с ID пользователя пуст.';
$string['error:useridinvalid'] = 'Строка {$a->line}: пользователь с ID {$a->userid} не найден.';
$string['error:useridinvalidsummary'] = 'Следующие строки пропущены из-за неверных ID пользователей: {$a}.';
