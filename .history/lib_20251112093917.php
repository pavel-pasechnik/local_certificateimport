...
\local_alternatename\bootstrap::init();
 ...
 */
function local_alternatename_before_http_headers() {
    global $CFG;
    ...
    if (!function_exists('core_user_get_fullname')) {
        ...
        function core_user_get_fullname(\stdClass $user, bool $override = false, array $options = []): string {
            if (function_exists('local_alternatename_core_user_get_fullname')) {
                return local_alternatename_core_user_get_fullname($user, $override, $options);
            }
